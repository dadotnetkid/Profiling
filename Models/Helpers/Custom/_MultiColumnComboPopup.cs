...
namespace Helpers.Custom
{
	...
	/// </summary>
	public class _MultiColumnComboPopup : System.Windows.Forms.Form
	{
		/// <summary>
		...
		public _MultiColumnComboPopup(DataRow[] drows) {
			InitializeComponent();
		...
		public _MultiColumnComboPopup(DataTable dtable, ref DataRow selRow, string[] colsToDisplay) {
			InitializeComponent();
