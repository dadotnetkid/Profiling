...
namespace Helpers.Custom
{
	...
	public class _MultiColumnComboBox : System.Windows.Forms.ComboBox
	{
		/// <summary>
		...
		protected override void OnDropDown(System.EventArgs e){
			...
			if(this.dataTable != null || this.dataRows!= null){
				_MultiColumnComboPopup popup = new _MultiColumnComboPopup(this.dataTable,ref this.selectedRow,columnsToDisplay);
